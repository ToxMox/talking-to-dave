...
var CONTRACT_REV="2026-08-11";
  function BEGIN_MARK(rev){
    return "\u003c!-- BEGIN presentation-contract rev="+(rev||CONTRACT_REV)
      +". Everything between these markers is replaced wholesale on update, so keep any edits of your own outside them. --\u003e";
  }
  function END_MARK(){ return "\u003c!-- END presentation-contract --\u003e"; }
  var EM={
  ...
  function buildContract(o){
    ...
    var out=BEGIN_MARK(o.rev)+"\n"
      +"## Talking to "+name+" (presentation contract)\n\n"
...
/*EXPORTS*/
export { buildContract, buildChatPreferences, buildPaletteMarkdown, paletteRows, sanitizeName, surfaceNote, CONTRACT_REV };
